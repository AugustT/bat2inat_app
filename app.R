                            ...
                            insertUI(
                                ...
                                ui = div(h3(name),
                                         ...
                                         div(id = 'metadata',
                                             ...
                                             span(strong('Number of calls: '), length(TD$freq_peak)), br(),
                                             span(strong('Av. Peak Frequency (kHz):'), round(median(TD$freq_peak)/1000)), br(),
                                             span(strong('Av. Call Duration (ms):'), round(median(TD$call_duration), digits = 1)),
